           ...
           <div className="h-[220px] py-20 text-center">
            ...
            <div className="">
                <div className="inline-flex w-full py-1">
                    <div className="flex h-7 flex-row border rounded shadow-sm w-full">
                        <button className={btnClass1.join(' ')}
                                onClick={() => setDefaultInput(true)}>По логину и паролю</button>

                        <button className={btnClass2.join(' ')}
                                onClick={() => setDefaultInput(false)}>По ЭЦП</button>
                    </div>
                </div>
                ...
                {defaultInput &&
                    <>
                        <div className="flex flex-col py-1">
                            ...
                            <input className="border rounded border-slate-400 px-2 text-sm h-[28px] outline-blue-700 focus-visible:outline-1  hover:border-blue-700 "
                        ...
                        <div className="flex flex-col py-1">
                            ...
                            <div className="flex flex-row">
                                <input className="w-full border rounded border-slate-400 px-2 text-sm h-[28px] outline-blue-700 focus-visible:outline-1  hover:border-blue-700 "
                                       placeholder="Введите пароль"
                                       type={hidePassword? "password":""}
                                />
                                <div className="absolute ml-80 mt-1">
                                    {hidePassword && <svg onClick={() => setHidePassword(false)} className="h-5 w-5 text-black" fill="none" viewBox="0 0 24 24"
                                                          stroke="currentColor">
                                    ...
                                    {!hidePassword && <svg onClick={() => setHidePassword(true)} className="h-5 w-5 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex justify-center pt-10">
                    <button className="w-[140px] h-[40px] bg-green-500 text-white rounded shadow-inner hover:bg-green-600">Войти</button>
                </div>
